...
The objective of the game is for the user to guess a randomly selected word by entering one letter at a time.
...
* Displays the word progress using underscores(\_)

* Prevents repeated guesses from reducing attempts
...
* Fundamental Python syntax and structure

* random library for selecting words

* while loop for continuous game execution
